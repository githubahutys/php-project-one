...
<div class="admin-content">
    <div class="admin-content-body">
        <div class="am-cf am-padding am-padding-bottom-0">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">酒店管理</strong> / <small>客房预订</small></div>
        </div>
            ...
            <div class="am-u-sm-12 am-u-md-6">
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <button type="button" class="am-btn am-btn-default" data-am-modal="{target: '#doc-modal-1', closeViaDimmer: 0, width: 500, height: 500}"><span class="am-icon-plus"></span> 新增预订</button>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <td>
                            <div class="am-dropdown" data-am-dropdown>
                                ...
                                <ul class="am-dropdown-content">
                                    <li><a href="reserve.php?Action=CheckIn&id={$row['id']}">1. 办理入住</a></li>
                                    <li><a href="reserve.php?Action=Del&id={$row['id']}">2. 取消预订</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
        ...
        <div class="am-modal-dialog">
            ...
            <div class="am-modal-bd">
                ...
                <div class="am-g am-center">
                    <div>
                        <form class="am-form am-form-horizontal am-center" action="reserve.php" method="post">
